                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            <a href="{{ route('voyager.suppliers.pay', $data->id) }}" title="{{ __('Payment') }}" class="btn btn-sm btn-primary pull-right" style="margin-right: 5px;">
                                                <i class="voyager-fire"></i> <span class="hidden-xs hidden-sm">{{ __('Payment') }}</span>
                                            </a>
                                        </td>
                                    </tr>
                                    @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-trash"></i> {{ __('voyager::generic.delete_question') }} {{ Auth::user()->settings['locale'] == 'ar' ? $dataType->display_name_ar_singular : strtolower($dataType->display_name_singular) }}?</h4>
                </div>
