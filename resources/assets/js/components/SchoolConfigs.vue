            ...
            <form @submit.prevent="validateBeforSubmit" action="">
                <div>
                        ...
                        <div class="panel panel-bordered">
                            <div class="panel-body">
                                <div :class="{'form-group col-md-12': true, 'has-error': errors.has('school-name') }">
                                    <label for="school-name">{{ trans('configs.School Name')}}</label>
                                    <input required type="text" v-validate="'required|min:3'" class="form-control" name="school-name" v-model="schoolConfigs.school_name" :placeholder="trans('configs.School Name')">
                                ...
                                <div :class="{'form-group col-md-6': true, 'has-error': errors.has('education-system') }">
                                    <label for="edu-system">{{ trans('configs.Educational System')}}</label>
                                    <select class="form-control" v-validate="'required'" id="education-system" name="education-system" v-model="schoolConfigs.edu_system_id">
                                        <option value="null">{{ trans('configs.None')}}</option>
                                ...
                                <div :class="{'form-group col-md-6': true, 'has-error': errors.has('website') }">
                                    <label for="website">{{ trans('configs.Website')}}</label>
                                    <input required type="text" class="form-control" v-validate="'url:require_protocol'" name="website" v-model="schoolConfigs.website" :placeholder="trans('configs.Website')">
                                ...
                                <div :class="{'form-group col-md-6': true, 'has-error': errors.has('government') }">
                                    <label for="government">{{ trans('configs.Government')}}</label>
                                ...
                                <div :class="{'form-group col-md-6': true, 'has-error': errors.has('edu-manag') }">
                                    <label for="edu-manag">{{ trans('configs.Educational Administration')}}</label>
                                ...
                                <div :class="{'form-group col-md-6': true, 'has-error': errors.has('school-manager') }">
                                    <label for="school-manager">{{ trans('configs.School Manager')}}</label>
                                    <input required type="text" class="form-control" name="school-manager" v-validate="'required'" :placeholder="trans('configs.School Manager')" v-model="schoolConfigs.school_manager">
                                    <span v-show="errors.has('school-manager')" class="help-block" style="color:#f96868">{{ errors.first('school-manager') }}</span>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="follow-manager">{{ trans('configs.Follow Manger')}}</label>
                                    <input type="text" class="form-control" name="follow-manager" :placeholder="trans('configs.Follow Manger')" v-model="schoolConfigs.follow_manager">
                                </div>
                                <div :class="{'form-group col-md-8': true, 'has-error': errors.has('address') }">
                                    <label for="address">{{ trans('configs.Address')}}</label>
                                    <input required type="text" class="form-control" v-validate="'required'" name="address" :placeholder="trans('configs.Address')" v-model="schoolConfigs.address">
                                    <span v-show="errors.has('address')" class="help-block" style="color:#f96868">{{ errors.first('address') }}</span>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="license-number">{{ trans('configs.License Number')}}</label>
                                    <input type="text" class="form-control" name="license-number" :placeholder="trans('configs.License Number')" v-model="schoolConfigs.license_number">
                                </div>
                                <div :class="{'form-group col-md-12': true, 'has-error': errors.has('footer') }">
                                    <label for="footer">{{ trans('configs.Footer')}}</label>
                                    <textarea class="form-control" name="footer" v-validate="'min:10:|max:500'" :placeholder="trans('configs.Type your footer')" v-model="schoolConfigs.footer"></textarea>
                    ...
                    <div class="col-md-4">
                        <div class="panel panel-bordered">
                            <div class="panel-body">
                                <croppa :width="350" v-model="images.logo" :height="350" :placeholder="trans('configs.Logo an School')" :placeholder-font-size="20">
                                </croppa>
                                <hr>
                                <croppa :width="350" v-model="images.cover" :height="150" :placeholder="trans('configs.Cover an School')" :placeholder-font-size="20">
                                </croppa>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div class="col-md-4">
                        <div class="panel panel-bordered">
                            <div class="panel-body">
                                <multi-telephone :options="telephones" :inputType="'text'" :name="trans('configs.Telephone')"></multi-telephone>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="panel panel-bordered">
                            <div class="panel-body">
                                <multi-mobile :options="mobiles" :inputType="'text'" :name="trans('configs.Mobile')"></multi-mobile>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="panel panel-bordered">
                            <div class="panel-body">
                                <multi-fax :options="faxes" :inputType="'text'" :name="trans('configs.Fax')"></multi-fax>
                            </div>
                        </div>
                    </div>
                    <div style="clear: both;"></div>
                ...
                <div class="col-md-8">
                    <div class="panel panel-bordered">
                        <div class="panel-body">
                            <multi-social :options="socialMedia" :selectOptions="socialMediaName" :name="trans('configs.SocialMedia')"></multi-social>
                        </div>
                        <div class="panel-footer">
                            <button type="submit" class="btn btn-primary">{{ trans('table.Yes, Save it!')}}</button>
                            <div style="clear: both;"></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="panel panel-bordered">
                        <div class="panel-body">
                            <multi-email :options="emails" :inputType="'email'" :name="trans('configs.Email')"></multi-email>
                        </div>
                    </div>
                </div>
            </form>
