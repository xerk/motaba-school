<template>
    <div class="container">
        <div class="row">
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-7">
                                    <span class="show-field">Qualification:</span>                                
                                </div>
                                <div class="col-md-5">
                                    {{ user.qualification }}
                                </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-7">
                                    <span class="show-field">Specialty:</span>                                
                                </div>
                                <div class="col-md-5">
                                    {{ user.specialty }}
                                </div>
            ...
            <div class="col-md-9">
                <div>
                    <a class="btn btn-new-relationship" @click="linkTeacherModal" v-if="linkTeachers != ''" title="make a payment"><i class="voyager-heart"></i> Add Link Teacher</a>
                </div>
                <div class="panel panel-bordered" >
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <div class="text-center" v-else>
                                <h3 >Please, add one link a teacher!.</h3>
                                <a class="btn btn-new-relationship" @click="linkTeacherModal" title="make a payment"><i class="voyager-heart"></i> Add Link Teacher</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <link-teacher-add :list="list" v-if="linkTeacherAddModal" @close="linkTeacherAddModal = false">
            <div slot="body">
                ...
                <div :class="{'form-group col-md-6': true, 'has-error': errors.has('classroom') }">
                    ...
                    <select id="classroom" class="form-control" v-validate="'required'" v-model="model.classRoomSelect" name="classroom">
                        <option value="" selected="selected">Choose Class-Room</option>
            ...
            <div slot="header" class="modal-header" style="background-color: #F2435C;">
                <h3 slot="header"><i class="voyager-heart"></i> <span style="margin-left: 10px;vertical-align: text-bottom;">Add Link Teacher.</span></h3>                        
            </div>
            <button slot="button" @click="parsist" class="btn btn-new-relationship">Yes, Save it!</button>
        </link-teacher-add>
