						...
						>
							<thead>
								<tr>
									...
									<th>
										{{ trans("reports.Last Name") }} المذهب
									</th>
									<th>
										{{
											trans("reports.Father Name")
										}}الجنسية
									</th>
									<th>
										{{ trans("reports.Father Job") }}تاريخ
										الميلاد
									</th>
									<th>
										{{
									...
									<th>
										{{ trans("reports.Father Tel") }}العنوان
									</th>
									<th>
										{{ trans("reports.Father Tel") }}المرحلة
									</th>
									<th>
										{{ trans("reports.Father Tel") }}الصف
									</th>
								</tr>
							</thead>
						</table>
			...
			fetch() {
				...
				$(function () {
					var t = $("#users-table").DataTable({
						...
						processing: false,
						serverSide: false,
						ajax: `https://old.schoolver.com/admin/get-doctrine?class=${classEdu}&classroom=${classRoom}`,
						columns: [
