    ...
    <div class="col-md-12">
        <div class="panel panel-bordered">
            <div class="panel-body">
                <h3 class="text-center">إحصائية المكفوفين</h3>
                ...
                <div class="content-header" style="display: none">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-center">
                            <h3 class="text-center">إحصائية المكفوفين</h3>
                            <h3 class="text-center" v-if="user != null"><span v-if="classEdu != ''">{{user.class_edu.name}}</span> <span v-if="classRoom != ''">- {{user.class_room.name}}</span></h3>
                        </div>
        ...
        fetch() {
            ...
            $(function() {
                var t = $('#users-table').DataTable({
                    ...
                    processing: false,
                    serverSide: false,
                    ajax: `https://kame-ouda.com/admin/get-blind?class=${classEdu}&classroom=${classRoom}`,
                    columns: [
