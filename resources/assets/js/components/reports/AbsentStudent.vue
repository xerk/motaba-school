	...
	<div class="page-content browse container-fluid">
		<div class="lecture-select-box">
			...
			<button class="btn btn-sm disabled" style="padding: 4px 15px">
				{{
					new Date() | moment("add", day + " days", "dddd, Do MM YY")
				}}
			</button>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-bordered">
					<div class="panel-body">
						<h3 class="text-center">كشف غياب طلاب</h3>
			...
			fetch() {
				...
				$(function () {
					$("#users-table").DataTable({
						...
						serverSide: false,
						paging: true,
						ajax: `https://old.schoolver.com/admin/get-student-absent?day=${day}&class=${classEdu}&classroom=${classRoom}`,
						columns: [
