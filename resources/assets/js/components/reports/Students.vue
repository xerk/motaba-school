						...
						>
							<thead>
								<tr style="display: none">
									<th>
										{{ trans("reports.Student Name") }}أسم
										الطالب
									</th>
									<th>
										{{ trans("reports.Last Name") }}الأسم
										الاخير
									</th>
									<th>
										{{ trans("reports.Birth") }}تاريخ
										الميلاد
									</th>
									<th colspan="3">
										{{ trans("reports.Data Oct") }}السن في
										أول اكتوبر
									</th>
									<th>
										{{ trans("reports.Situation") }}الحالة
									</th>
									<th>
										{{ trans("reports.Joining Date") }}الرقم
										القومي
									</th>
									<th>
										{{ trans("reports.National") }}الجنسية
									</th>
									<th>{{ trans("reports.Gender") }}النوع</th>
									<th>
										{{ trans("reports.Address") }}العنوان
									</th>
									<th>
										{{
											trans("reports.Father Mobile")
										}}تليفون الأب
									</th>
									<th>
										{{
											trans("reports.Mother Mobile")
										}}تليفون الأم
									</th>
									<th>
										{{ trans("reports.Joining Date") }}وظيفة
										الأب
									</th>
								</tr>
								<tr>
			...
			fetch() {
				...
				$(function () {
					var t = $("#users-table").DataTable({
						...
						paging: false,
						serverSide: false,
						ajax: `https://old.schoolver.com/admin/get-students?class=${classEdu}&classroom=${classRoom}`,
						columns: [
