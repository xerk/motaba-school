<template>
    <div class="page-content browse container-fluid">
        <div class="lecture-select-box">
            <router-link @click.native="next" style="padding: 5px 10px;" title="Next" class="btn btn-sm  btn-primary pull-right edit" tag="a" :to="{path: '/admin/absent_employees', query: {'day': day+1,}}">
                <span class="hidden-xs hidden-sm"></span> <i class="voyager-double-right"></i>
            </router-link>
            <router-link @click.native="prev" style="padding: 5px 10px;" title="Prev" class="btn btn-sm  btn-primary pull-right edit" tag="a" :to="{path: '/admin/absent_employees', query: {'day': day-1,}}">
