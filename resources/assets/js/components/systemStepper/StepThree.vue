        ...
        <div class="row">
            ...
            <div v-for="(option, key) in $v.form.options.$each.$iter" :key="key">
                <div :class="['form-group col-md-4', (option.$error) ? 'has-error' : '']">
                    ...
                    <span v-if="option.$error" class="help-block" style="color:#f96868">This class is invalid</span>
                </div>
                <div :class="['form-group col-md-4', (option.$error) ? 'has-error' : '']">
                    <input required="" type="text" class="form-control" v-model.trim="option.name.$model"  placeholder="Type class-room name" value="">
                    <span v-if="option.$error" class="help-block" style="color:#f96868">This class-room is invalid</span>
                </div>
                <div class="form-group col-md-2">
                    ...
                    <modal v-if="showModal" @close="showModal = false">
                        ...
                        default content
                        -->
                        <h3 slot="header"><i class="voyager-trash"></i> Are you sure you want to delete this class-room?</h3>
            ...
            <div class="form-group col-md-12">
                ...
                <a @click="addOption" class="btn btn-success">+ Add New ClassRoom</a>
            </div>
        </div>
    </div>
</template>
