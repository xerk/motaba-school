<template>
    <div class="page-content browse container-fluid">
        <div class="attend-button">
            <a :href="'http://localhost/api/export-results?class_id='+ classEdu +'&classroom_id='+ classRoom +'&subject_id='+ supSubject +'&exam_id='+ exam" class="btn btn-sm  btn-primary pull-right delete">
