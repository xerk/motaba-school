                                                ...
                                                <transition-group tag="tbody" name="list" mode="in-out">
                                                    <tr v-for="(item, index) in retriveSearch" :key="index">
                                                        ...
                                                        <td class="no-sort no-click" id="bread-actions">
                                                            ...
                                                            <router-link tag="a"
                                                                :to="{ name: 'paymentDetails', params: {id: item.id} }"
                                                                :title="trans('salary.Make Payment')"
                                                                class="btn btn-sm btn-info pull-right add" data-id="2"
                                                                id="add-2">
                                                                <i class="voyager-credit-card"></i> <span
                                                                    class="hidden-xs hidden-sm">{{ trans('salary.Make Payment')}}</span>
                                                            </router-link>
                                                        </td>
                                                    </tr>
                                                </transition-group>
