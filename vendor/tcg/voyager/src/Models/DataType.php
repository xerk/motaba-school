...
class DataType extends Model
{
    ...
    protected $translatable = ['display_name_singular', 'display_name_plural', 'display_name_ar_singular', 'display_name_ar_plural'];
    ...
    protected $fillable = [
        ...
        'display_name_plural',
        'display_name_ar_singular',
        'display_name_ar_plural',
        'icon',
        'model_name',
        'policy_name',
        'controller',
        ...
        try {
            ...
            if ($this->fill($requestData)->save()) {
                ...
                foreach ($fields as $field) {
                    ...
                    $dataRow->display_name_ar = $requestData['field_display_name_ar_'.$field];
