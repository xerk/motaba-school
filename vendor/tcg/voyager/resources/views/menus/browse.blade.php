...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-list-add"></i> {{ Auth::user()->settings['locale'] == 'ar' ? $dataType->display_name_ar_plural : $dataType->display_name_plural }}
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <i class="voyager-trash"></i> {{ __('voyager::generic.delete_question') }} {{ Auth::user()->settings['locale'] == 'ar' ? $dataType->display_name_ar_singular : $dataType->display_name_singular }}?
                    </h4>
                </div>
                <div class="modal-footer">
                    <form action="#" id="delete_form" method="POST">
                        {{ method_field("DELETE") }}
                        {{ csrf_field() }}
                        <input type="submit" class="btn btn-danger pull-right delete-confirm" value="{{ __('voyager::generic.delete_this_confirm') }} {{ Auth::user()->settings['locale'] == 'ar' ? $dataType->display_name_ar_singular : $dataType->display_name_singular }}">
                    </form>
