            ...
            <div class="modal-content">
                ...
                <form action="" id="m_form" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <label for="name_ar">{{ __('voyager::menu_builder.item_title_ar') }}</label>
                        @include('voyager::multilingual.input-hidden', ['_field_name' => 'title_ar', '_field_trans' => ''])
                        <input type="text" class="form-control" id="m_title_ar" name="title_ar" placeholder="{{ __('voyager::generic.title_ar') }}"><br>
