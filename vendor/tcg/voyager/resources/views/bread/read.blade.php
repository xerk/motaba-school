...
@section('page_title', __('voyager::generic.view').' '.(Auth::user()->settings['locale'] == 'ar' ? $dataType->display_name_ar_singular : $dataType->display_name_singular))

@section('page_header')
    <h1 class="page-title">
        <i class="{{ $dataType->icon }}"></i> {{ __('voyager::generic.viewing') }} {{ ucfirst(Auth::user()->settings['locale'] == 'ar' ? $dataType->display_name_ar_singular : $dataType->display_name_singular) }} &nbsp;
                    ...
                    @foreach($dataType->readRows as $row)
                        ...
                        <div class="panel-heading" style="border-bottom:0;">
                            @if (Auth::user()->settings['locale'] == 'ar')
                                <h3 class="panel-title">{{ $row->display_name_ar }}</h3>
                            @else
