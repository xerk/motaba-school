                    ...
                    <div class="panel panel-primary panel-bordered">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="display_name_ar_singular">{{ __('voyager::bread.display_name_ar_singular') }}</label>
                                    @if($isModelTranslatable)
                                        @include('voyager::multilingual.input-hidden', [
                                            'isModelTranslatable' => true,
                                            '_field_name'         => 'display_name_ar_singular',
                                            '_field_trans' => get_field_translations($dataType, 'display_name_ar_singular')
                                        ])
                                    @endif
                                    <input type="text" class="form-control"
                                           name="display_name_ar_singular"
                                           id="display_name_ar_singular"
                                           placeholder="{{ __('voyager::bread.display_name_ar_singular') }}"
                                           value="@if(isset($dataType->display_name_ar_singular)){{ $dataType->display_name_ar_singular }}@else{{ $display_name }}@endif">
                                </div>
                                <div class="col-md-6 form-group">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="display_name_ar_plural">{{ __('voyager::bread.display_name_ar_plural') }}</label>
                                     @if($isModelTranslatable)
                                        @include('voyager::multilingual.input-hidden', [
                                            'isModelTranslatable' => true,
                                            '_field_name'         => 'display_name_ar_plural',
                                            '_field_trans' => get_field_translations($dataType, 'display_name_ar_plural')
                                        ])
                                    @endif
                                    <input type="text" class="form-control"
                                           name="display_name_ar_plural"
                                           id="display_name_ar_plural"
                                           placeholder="{{ __('voyager::bread.display_name_ar_plural') }}"
                                           value="@if(isset($dataType->display_name_ar_plural)){{ $dataType->display_name_ar_plural }}@else{{ $display_name_plural }}@endif">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
