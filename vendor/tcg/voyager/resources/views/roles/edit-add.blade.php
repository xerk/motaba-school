...
@section('page_title', __('voyager::generic.'.(isset($dataTypeContent->id) ? 'edit' : 'add')).' '.(Auth::user()->settings['locale'] == 'ar' ? $dataType->display_name_ar_singular : $dataType->display_name_singular))
...
@section('page_header')
    <h1 class="page-title">
        ...
        {{ __('voyager::generic.'.(isset($dataTypeContent->id) ? 'edit' : 'add')).' '.(Auth::user()->settings['locale'] == 'ar' ? $dataType->display_name_ar_singular : $dataType->display_name_singular) }}
    </h1>
@stop
