...
class RouterListenerTest extends TestCase
{
    ...
    {
        return array(
            array(80, 443, 'https://old.schoolver.com/', 80, 443),
            array(80, 443, 'https://old.schoolver.com:90/', 90, 443),
    ...
    {
        $kernel = $this->getMockBuilder('Symfony\Component\HttpKernel\HttpKernelInterface')->getMock();
        $request = Request::create('https://old.schoolver.com/');
    ...
    {
        $kernel = $this->getMockBuilder('Symfony\Component\HttpKernel\HttpKernelInterface')->getMock();
        $request = Request::create('https://old.schoolver.com/', 'post');
        $event = new GetResponseEvent($kernel, $request, HttpKernelInterface::MASTER_REQUEST);
        ...
        $kernel = $this->getMockBuilder('Symfony\Component\HttpKernel\HttpKernelInterface')->getMock();
        $request = Request::create('https://old.schoolver.com/', 'get');
    ...
    {
        return array(
            array(array('_route' => 'foo'), 'Matched route "{route}".', array('route' => 'foo', 'route_parameters' => array('_route' => 'foo'), 'request_uri' => 'https://old.schoolver.com/', 'method' => 'GET')),
            array(array(), 'Matched route "{route}".', array('route' => 'n/a', 'route_parameters' => array(), 'request_uri' => 'https://old.schoolver.com/', 'method' => 'GET')),
        );
    }
