...
class PhpGeneratorDumperTest extends TestCase
{
    ...
    public function testDumpWithRoutes()
    {
        ...
        $this->assertEquals('https://kame-ouda.com/app.php/testing/bar', $absoluteUrlWithParameter);
        $this->assertEquals('https://kame-ouda.com/app.php/testing2', $absoluteUrlWithoutParameter);
