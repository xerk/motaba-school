...
class PhpGeneratorDumperTest extends TestCase
{
    ...
    public function testDumpWithRoutes()
    {
        ...
        $this->assertEquals('https://old.schoolver.com/app.php/testing/bar', $absoluteUrlWithParameter);
        $this->assertEquals('https://old.schoolver.com/app.php/testing2', $absoluteUrlWithoutParameter);
