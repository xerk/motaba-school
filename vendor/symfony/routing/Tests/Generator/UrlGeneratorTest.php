...
class UrlGeneratorTest extends TestCase
{
    public function testAbsoluteUrlWithPort80()
    {
        ...
        $this->assertEquals('https://kamelouda.com/app.php/testing', $url);
    }
    ...
    public function testAbsoluteUrlWithNonStandardPort()
    {
        ...
        $this->assertEquals('https://kamelouda.com:8080/app.php/testing', $url);
    }
    ...
    public function testAbsoluteUrlWithExtraParameters()
    {
        ...
        $this->assertEquals('https://kamelouda.com/app.php/testing?foo=bar', $url);
    }
    ...
    public function testSchemeRequirementForcesAbsoluteUrl()
    {
        ...
        $routes = $this->getRoutes('test', new Route('/', array(), array(), array(), '', array('http')));
        $this->assertEquals('https://kamelouda.com/app.php/', $this->getGenerator($routes, array('scheme' => 'https'))->generate('test'));
    }
