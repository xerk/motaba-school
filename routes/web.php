...
Route::group(['as' => 'frontend.'], function () {
    ...
    Route::get('/attentions/@{username}', 'AttentionAccountController@index')->name('attentions')->middleware('admin.user');
    Route::get('/attentions/@{username}/{id}', 'AttentionAccountController@index')->name('attention.show')->middleware('admin.user');

    Route::get('/', 'LandingPageController@index')->name('home');

    Route::get('/news', 'LandingPageController@index')->name('news');
